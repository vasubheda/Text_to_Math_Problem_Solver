...
prompt="""
You are an agent tasked for solving users mathematical questions. Logically arrive at the solutions and provide a detailed explanation
...
if st.button("find my answer"): ## Interact with the agent once the button is clicked
    if question:
